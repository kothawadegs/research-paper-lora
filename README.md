...
| Kothawade, Chandel et al., "High throughput canopy characterization of a commercial apple orchard using aerial RGB imagery," *IEEE MetroAgriFor* 2021 | First author |
| Ranjan, Kothawade et al., "Does YOLO26 Truly Offer Advantages Over Its Predecessors for Edge Deployment?" | Co-author |
| Ranjan, Kothawade et al., "Feasibility study of FAIMS for rapid off-flavor detection... cultured Atlantic salmon," *Aquacultural Engineering* 2026 | Co-author |
| Tolomelli, Kothawade et al., "Aerial-RGB imagery based 3D canopy reconstruction... of grapevines," *IEEE MetroAgriFor* 2022 | Co-author |
| Dhakar, Amogi, Kothawade, Khot, "Simplified mechanistic model for estimating leaf wetness," *Agricultural and Forest Meteorology* 2025 | Co-author |
...
An earlier version of this dataset included a rice-area-mapping paper (Mohite et al.);
that paper was swapped out in favor of two additional papers, so the dataset now leans
more heavily on first-author work.
...
**A second training run** was later performed after the dataset was updated (see Data
Sources above) to swap the rice-mapping paper for two additional papers, bringing the
dataset from 42 to 53 examples. That run's full outputs, including a genuinely useful
mistake (an early attempt accidentally trained on a stale copy of the old dataset) and
a more specific finding about which facts generalize under paraphrase, are in
[`results/eval_results_v2.md`](results/eval_results_v2.md).
